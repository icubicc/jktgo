...
gulp.task('kit-js-dist', function() {
	return gulp.src('kit/**/*.kit')
		...
		.pipe(gulpIf('library/js/bundle.js', babel({ presets: ['env'] })))
		.pipe(gulpIf('library/js/bundle.js', uglify()))
		.pipe(gulp.dest('dist/'));
});
...
gulp.task('js-hint', function() {
	gulp.src(['library/js/style.js', 'library/js/scripts.js'])
...
gulp.task('svg-sprite', ['svg'], function() {
	return gulp.src('library/images/symbols/**/*.svg')
		.pipe(svgmin({
			plugins: [{
				removeViewBox: false
			}, {
...
gulp.task('library', function() {
	return gulp.src(['library/**/*', '!library/images/**/*.svg', '!library/js/**/*', '!library/{scss,scss/**}'])
...
gulp.task('watch', function() {
	...
	gulp.watch(['library/**/*', '!library/images/**/*.svg', '!library/{js,js/**}', '!library/{scss,scss/**}'], ['library']);
	gulp.watch('library/images/**/*.svg', ['svg', 'svg-sprite']);
	gulp.watch('library/js/**/*.js', ['js-reload']);
	gulp.watch('library/scss/**/*.scss', ['sass' , 'demo-sass', 'doc-sass']);
	gulp.watch('uploads/**/*', ['uploads']);
});

// Cleaning unused library
...
gulp.task('default', function() {
	runSequence(['kit', 'sass', 'js', 'demo-kit', 'demo-sass', 'doc-kit', 'doc-sass', 'root', 'library', 'svg-sprite', 'uploads', 'browserSync', 'watch']);
});

gulp.task('build', function() {
	runSequence('clean', 'kit-js-dist', ['sass', 'demo-kit', 'demo-sass', 'doc-kit', 'doc-sass', 'root', 'library', 'svg-sprite', 'uploads']);
});
